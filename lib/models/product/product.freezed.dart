...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, title: $title, description: $description, price: $price, currencyCode: $currencyCode, isSubscription: $isSubscription)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, description, price, currencyCode, isSubscription);
...
abstract class _Product implements Product {
  const factory _Product(
      ...
      required final bool isSubscription}) = _$ProductImpl;
